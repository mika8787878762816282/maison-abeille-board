...
const INIT_NODES = [
  ...
  // ── WORKFLOWS cluster ──
  { id:'workflows', x:1680, y:720, w:240, h:50, text:'WORKFLOWS MAISON ABEILLE', color:'#1e2a4a', fs:12 },

  { id:'apicrypt',       x:1780, y:290, w:280, h:56,
    text:'APICRYPT DOCTOLIB — ENVOI MSG RÉSULTATS AVEC FICHIER ANAPATH', color:'#1e2a4a', fs:9 },
  { id:'install_api',    x:1400, y:410, w:160, h:42, text:'installe apicrypt', color:'#1e2a4a', fs:11 },
  { id:'benin',          x:1720, y:410, w:110, h:42, text:'BENIN',             color:'#1e2a4a', fs:12 },
  { id:'malin',          x:1880, y:410, w:110, h:42, text:'MALIN',             color:'#1e2a4a', fs:12 },
  { id:'doctolib_visio', x:2160, y:400, w:250, h:50,
    text:'DOCTOLIB — ENVOI MSG POUR PRENDRE RDV VISIO', color:'#1e2a4a', fs:9 },
  { id:'scraper',        x:1880, y:550, w:280, h:64,
    text:'SCRAPER TOUS LES RÉSULTATS POUR RÉLIQUER CLAUDE ENTRE BENIN ET MALIN', color:'#1e2a4a', fs:9 },
  { id:'seloquer',       x:2260, y:570, w:190, h:44, text:'a séloquer le fichier', color:'#1e2a4a', fs:11 },

  { id:'remise',         x:1490, y:630, w:250, h:48,
    text:'REMISE DES RÉSULTATS ANAPATH', color:'#1e2a4a', fs:11 },
  { id:'mails_chir',     x:2030, y:640, w:280, h:54,
    text:'ENVOYER MAILS À TOUS LES CHIRURGIENS & LISTING DE RDV', color:'#1e2a4a', fs:9 },
  { id:'avis_google',    x:2030, y:730, w:260, h:50,
    text:'GESTION DES AVIS GOOGLE ET BLOCAGE DOCTOLIB', color:'#1e2a4a', fs:9 },
  { id:'sheet_url',      x:2390, y:700, w:280, h:44,
    text:'docs.google.com/spreadsheets/…', color:'#1e2a4a', fs:9 },
  { id:'drive_excel',    x:2390, y:790, w:220, h:44, text:'CRÉER AUTRE DRIVE EXCELL', color:'#1e2a4a', fs:10 },

  { id:'inventaire',     x:1490, y:830, w:160, h:46, text:'INVENTAIRE',       color:'#1e2a4a', fs:13 },
  { id:'amazon',         x:1900, y:830, w:160, h:46, text:'AMAZON',           color:'#1e2a4a', fs:13 },
  { id:'auto_cmd',       x:1620, y:930, w:250, h:50,
    text:'automation COMMANDES CONSOMMABLES', color:'#1e2a4a', fs:10 },
  { id:'pennylane',      x:2210, y:900, w:220, h:46, text:'PENNYLANE PAIEMENT', color:'#1e2a4a', fs:12 },
  { id:'fournisseurs',   x:1900, y:990, w:180, h:44, text:'FOURNISSEURS',       color:'#1e2a4a', fs:12 },

  { id:'raniellopoulou', x:1150, y:880, w:280, h:56,
    text:'DR RANIELLOPOULOU : ENVOI MESSAGES DOCTOLIB AVANT LES RDV', color:'#1e2a4a', fs:9 },
  { id:'ecrire_cond',    x:1150, y:970, w:200, h:44, text:'écrire les conditions', color:'#1e2a4a', fs:11 },
  { id:'esign',          x:1550, y:1040, w:220, h:46, text:'E-SIGNATURE DES DEVIS', color:'#1e2a4a', fs:12 },
  { id:'lovable_url',    x:1920, y:1080, w:280, h:44,
    text:'spacefine-demo.lovable.app/…', color:'#1e2a4a', fs:9 },
  { id:'nepting',        x:1200, y:1070, w:260, h:46,
    text:'NEPTING RAPPROCHEMENT EXCELL', color:'#1e2a4a', fs:10 },
  { id:'rabah',          x:1200, y:1170, w:280, h:54,
    text:'RABAH APPELER POUR SÉPARER LAGACHE 0651032462', color:'#1e2a4a', fs:9 },
  { id:'lano',           x:1550, y:1130, w:260, h:46,
    text:'LANO REPORTER DEPUIS MEDIPATH', color:'#1e2a4a', fs:10 },
  { id:'msg_doct',       x:1920, y:1170, w:230, h:46,
    text:'ENVOYER MESSAGE DANS DOCTOLIB', color:'#1e2a4a', fs:10 },
];

const INIT_EDGES = [
  // MISSIONS hub
  { id:'e1',  from:'missions', to:'ma' },
  { id:'e2',  from:'missions', to:'contacts' },
  ...
  { id:'e8',  from:'missions', to:'data' },
  { id:'e9',  from:'missions', to:'site_ma' },
  ...
  { id:'e23', from:'calendly', to:'auto_doct' },
  ...
  { id:'e34', from:'apicrypt',     to:'doctolib_visio' },
